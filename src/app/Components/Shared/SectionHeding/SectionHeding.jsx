...
const SectionHeding = ({title, hTitle, description}) => {
    return (
        <div className='text-center w-[600px] mx-auto space-y-3 pb-20'>
            ...
            <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white capitalize ">{title}&nbsp;<span class="underline underline-offset-3 decoration-8 decoration-[#00ff84] dark:decoration-blue-600">{hTitle}</span></h1>
